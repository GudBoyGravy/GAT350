...
void PostProcess::Invert(const ColorBuffer& colorBuffer)
{
...
void PostProcess::Monochrome(const ColorBuffer& colorBuffer)
{
	for (int i = 0; i < colorBuffer.width * colorBuffer.height; i++)
	{
		color_t& color = ((color_t*)colorBuffer.data)[i];
...
void PostProcess::ColorBalance(const ColorBuffer& colorBuffer, int16_t ro, int16_t go, int16_t bo)
{
	for (int i = 0; i < colorBuffer.width * colorBuffer.height; i++)
	{
		color_t& color = ((color_t*)colorBuffer.data)[i];
...
void PostProcess::Brightness(const ColorBuffer& colorBuffer, int16_t brightness)
{
	for (int i = 0; i < colorBuffer.width * colorBuffer.height; i++)
	{
		color_t& color = ((color_t*)colorBuffer.data)[i];
...
void PostProcess::Noise(const ColorBuffer& colorBuffer, uint8_t noise)
{
	for (int i = 0; i < colorBuffer.width * colorBuffer.height; i++)
	{
		color_t& color = ((color_t*)colorBuffer.data)[i];
...
void PostProcess::Threshold(const ColorBuffer& colorBuffer, uint8_t threshold)
{
	for (int i = 0; i < colorBuffer.width * colorBuffer.height; i++)
	{
		color_t& color = ((color_t*)colorBuffer.data)[i];
...
void PostProcess::BoxBlur(const ColorBuffer& colorBuffer)
{
...
void PostProcess::GaussianBlur(const ColorBuffer& colorBuffer)
{
	ColorBuffer source = colorBuffer;
	int16_t k[3][3] =
	{
...
void PostProcess::Sharpen(const ColorBuffer& colorBuffer)
{
	ColorBuffer source = colorBuffer;
	int16_t k[3][3] =
	{
...
void PostProcess::Edge(const ColorBuffer& colorBuffer, uint8_t threshold)
{
	ColorBuffer source = colorBuffer;
	int16_t kh[3][3] =
	{
